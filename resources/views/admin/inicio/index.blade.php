        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Quantidade em estoque por marca</h5>
                </div>
                <div class="card-body" id="qtyStockByBrands"></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Quantidade em estoque</h5>
                </div>
                <div class="card-body" id="qtyInStock"></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body" id="priceInStock"></div>
            </div>
        </div>
    </div>
@stop
