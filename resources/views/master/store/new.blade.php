                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6 no-padding">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="store_fancy" name="store_fancy" value="{{ old('store_fancy') }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <label class="col-md-12"><input type="radio" name="type_store" value="pf" {{ old('type_store') === 'pf' ? 'checked' : '' }} required> Pessoa Física</label>
                                <label class="col-md-12"><input type="radio" name="type_store" value="pj" {{ old('type_store') === 'pj' ? 'checked' : '' }} required> Pessoa Jurídica</label>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="document_primary_store">CNPJ</label>
                                <input type="text" class="form-control" id="document_primary_store" name="document_primary" value="{{ old('document_primary') }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="document_secondary_store">IE</label>
                                <input type="text" class="form-control" id="document_secondary_store" name="document_secondary" value="{{ old('document_secondary') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>Tipo de Domínio</label>
                                <label class="col-md-12"><input type="radio" name="domain" value="1" {{ old('domain') == 1 ? 'checked' : '' }} required> Domínio Próprio</label>
                                <label class="col-md-12"><input type="radio" name="domain" value="0" {{ old('domain') == 0 ? 'checked' : '' }} required> Domínio Compartilhado</label>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="with_domain_store">Domínio Próprio</label>
                                <input type="text" class="form-control" id="with_domain_store" name="with_domain" value="{{ old('with_domain') }}">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="without_domain">Nome do Domínio</label>
                                <input type="text" class="form-control" id="without_domain" name="without_domain" value="{{ old('without_domain') }}">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="email" class="form-control" id="email_store" name="email_store" value="{{ old('email_store') }}">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="password_store">Senha E-mail</label>
                                <input type="password" class="form-control" id="password_store" name="password_store" value="{{ old('password_store') }}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="mail_smtp">Endereço SMTP</label>
                                <input type="text" class="form-control" id="mail_smtp" name="mail_smtp" value="{{ old('mail_smtp') }}">
                            </div>
                            <div class="form-group col-md-2">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" id="mail_security" name="mail_security" value="{{ old('mail_security') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12 border-top pt-2">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="email" class="form-control" id="contact_email_store" name="contact_email_store" value="{{ old('contact_email_store') }}">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text pb-0 pt-0 pl-1 pr-1">
                                            <input type="checkbox" value="1" name="contact_primary_phone_store_whatsapp" id="contact_primary_phone_store_whatsapp" {{ old('contact_primary_phone_store_whatsapp') == 1 ? 'checked' : '' }}>
                                    ...
                                    <input type="text" class="form-control" id="contact_primary_phone_store" name="contact_primary_phone_store" value="{{ old('contact_primary_phone_store') }}">
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text pb-0 pt-0 pl-1 pr-1">
                                            <input type="checkbox" value="1" name="contact_secondary_phone_store_whatsapp" id="contact_secondary_phone_store_whatsapp" {{ old('contact_secondary_phone_store_whatsapp') == 1 ? 'checked' : '' }}>
                                            <label for="contact_secondary_phone_store_whatsapp" class="no-margin">
                                                <img src="https://imagepng.org/wp-content/uploads/2017/08/whatsapp-icone-4.png" width="33">
                                            </label>
                                        </span>
                                    </div>
                                    <input type="text" class="form-control" id="contact_secondary_phone_store" name="contact_secondary_phone_store" value="{{ old('contact_secondary_phone_store') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group colorpicker-primary">
                                    <input type="text" class="form-control" name="color-primary" autocomplete="off" value="{{ old('color-primary') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-square" style="color: {{ old('color-primary') }}"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group colorpicker-secundary">
                                    <input type="text" class="form-control" name="color-secundary" autocomplete="off" value="{{ old('color-secundary') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-square" style="color: {{ old('color-secundary') }}"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descriptionService" id="descriptionService">{{ old('descriptionService') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control" id="plan_expiration_date" name="plan_expiration_date" value="{{ old('plan_expiration_date') }}">
                            </div>
                        </div>
                        <input type="hidden" name="store_lat" value="{{ old('store_lat') }}">
                        <input type="hidden" name="store_lng" value="{{ old('store_lng') }}">
...
@section('js')
    ...
    <script>
        $(function () {
            ...
            if (!$('[name="type_store"]:checked').length)
                $('[name="type_store"][value="pf"]').prop('checked', true);
