...
class StoreController extends Controller
{
    ...
    private function formatFieldsStore(Request $data): array
    {
        ...
        $dataFormat = array(
            ...
            "store_document_primary"                => !isset($data['store_document_primary']) ? NULL : filter_var(preg_replace('/\D/', '', $data['document_primary']), FILTER_SANITIZE_STRING),
            "store_document_secondary"              => !isset($data['store_document_secondary']) ? NULL : filter_var(preg_replace('/\D/', '', $data['document_secondary']), FILTER_SANITIZE_STRING),
