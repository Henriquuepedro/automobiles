...
class StoreController extends Controller
{
    ...
    private function formatFieldsStore(Request $data): array
    {
        ...
        $dataFormat = array(
            ...
            "document_primary"                      => !isset($data['document_primary']) ? NULL : filter_var(preg_replace('/\D/', '', $data['document_primary']), FILTER_SANITIZE_STRING),
            "document_secondary"                    => !isset($data['document_secondary']) ? NULL : filter_var(preg_replace('/\D/', '', $data['document_secondary']), FILTER_SANITIZE_STRING),
