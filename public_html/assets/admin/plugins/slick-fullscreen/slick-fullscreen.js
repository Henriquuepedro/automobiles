(function(window, $) {
    ...
    var slickFullscreen = {
        ...
        open: function($slides, options) {
            ...
            $('#viewImagesAuto .modal-body').empty().append($container);
            ...
            $('#viewImagesAuto').modal();

            setTimeout(() => {
                $('.slick-fullscreen').slick('setPosition');
                $('#viewImagesAuto .slick-slide.slick-active').focus();

                $('#viewImagesAuto .slick-slide').zoom();
            }, 250);
        },
