...
class CreateRentCharacteristicsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rent_characteristics', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rent_characteristics');
    }
}
